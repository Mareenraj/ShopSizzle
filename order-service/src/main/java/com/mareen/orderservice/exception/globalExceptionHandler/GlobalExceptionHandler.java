package com.mareen.orderservice.exception.globalExceptionHandler;

import com.mareen.orderservice.dto.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public ApiError handleBusinessException(BusinessException exception, WebRequest request) {
        return new ApiError(
                LocalDateTime.now(),
