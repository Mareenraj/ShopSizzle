package com.mareen.productservice.exception.globalExceptionHandler;

import com.mareen.productservice.dto.ApiError;
import com.mareen.productservice.exception.ProductPurchaseException;
...
public class GlobalExceptionHandler {
    ...
    public ApiError handleEmailAlreadyExistsException(ProductPurchaseException exception, WebRequest request) {
        return new ApiError(
                LocalDateTime.now(),
